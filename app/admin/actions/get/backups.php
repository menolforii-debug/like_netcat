...
if ($backupFiles === []) {
    ...
    foreach ($backupFiles as $file) {
        ...
        echo '<form class="d-inline-flex align-items-center gap-2 me-2" method="post" action="/admin.php?action=backups_restore" data-confirm="Восстановить из этого бэкапа? Текущие данные будут перезаписаны.">';
        echo csrf_token_field();
