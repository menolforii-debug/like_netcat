...
echo '<a class="btn btn-link p-0 link-dotted" href="' . htmlspecialchars(buildAdminUrl(['section_id' => $sectionId, 'tab' => 'infoblocks']), ENT_QUOTES, 'UTF-8') . '">Назад</a>';
echo '</div>';
...
echo '<textarea class="form-control font-monospace code-editor" name="before_html" rows="2"></textarea>';
...
echo '<div class="js-code-editor-wrapper">';
echo '<textarea class="form-control font-monospace code-editor" name="after_html" rows="2"></textarea>';
echo '<div class="d-flex gap-2 mt-2">';
echo '<button class="btn btn-link p-0 link-dotted js-code-editor-expand" type="button">Развернуть</button>';
echo '<button class="btn btn-link p-0 link-dotted js-code-editor-collapse d-none" type="button">Свернуть</button>';
echo '</div>';
