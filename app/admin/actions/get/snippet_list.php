...
echo '<a class="btn btn-primary" href="' . htmlspecialchars(buildAdminUrl(['action' => 'snippet_list']), ENT_QUOTES, 'UTF-8') . '">Создать</a>';
echo '</div>';
...
if (empty($snippets)) {
    ...
    foreach ($snippets as $snippet) {
        ...
        $activeClass = $keyword === $snippet ? ' active' : '';
        echo '<a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center' . $activeClass . '" href="' . htmlspecialchars($link, ENT_QUOTES, 'UTF-8') . '">';
