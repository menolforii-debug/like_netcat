...
echo '<div class="col-md-6"><label class="form-label">Ключ</label><input class="form-control" type="text" name="key" value="' . htmlspecialchars((string) ($infoblock['key'] ?? ''), ENT_QUOTES, 'UTF-8') . '"></div>';
...
echo '<textarea class="form-control font-monospace code-editor" name="before_html" rows="6">' . htmlspecialchars((string) ($extra['before_html'] ?? ''), ENT_QUOTES, 'UTF-8') . '</textarea>';
...
echo '<div class="js-code-editor-wrapper">';
echo '<textarea class="form-control font-monospace code-editor" name="after_html" rows="6">' . htmlspecialchars((string) ($extra['after_html'] ?? ''), ENT_QUOTES, 'UTF-8') . '</textarea>';
echo '<div class="d-flex gap-2 mt-2">';
echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-expand" type="button">Развернуть</button>';
echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-collapse d-none" type="button">Свернуть</button>';
echo '</div>';
