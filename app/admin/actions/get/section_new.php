...
echo '<input class="form-check-input" type="checkbox" name="show_in_menu_inherit" value="1" checked>';
...
echo '<input class="form-check-input" type="checkbox" name="show_in_menu" value="1" checked>';
