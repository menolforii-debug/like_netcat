...
function renderComponentsBlock(array $ctx, bool $wrap): void
{
    ...
    if ($viewName !== '') {
        ...
        if ($isNewView) {
            ...
            echo '</div>';
            echo '<div class="mb-3 js-code-editor-wrapper">';
            echo '<label class="form-label">Настройки запроса (JSON)</label>';
            echo '<textarea class="form-control font-monospace code-editor" name="query_json" rows="10">' . renderTextareaValue(defaultQueryJson()) . '</textarea>';
            echo '<div class="mt-2 d-flex gap-2">';
            echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-expand" type="button">Развернуть</button>';
            echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-collapse d-none" type="button">Свернуть</button>';
            echo '</div>';
            ...
            echo '<div class="mb-3 js-code-editor-wrapper">';
            echo '<label class="form-label">Настройки запроса (JSON)</label>';
            echo '<textarea class="form-control font-monospace code-editor" name="query_json" rows="10">' . renderTextareaValue($viewRow['query_json'] ?? '') . '</textarea>';
            echo '<div class="mt-2 d-flex gap-2">';
            echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-expand" type="button">Развернуть</button>';
            echo '<button class="btn btn-sm btn-outline-secondary js-code-editor-collapse d-none" type="button">Свернуть</button>';
            echo '</div>';
