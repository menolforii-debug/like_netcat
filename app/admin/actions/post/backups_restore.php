...
$targetsToCleanup = $archiveTargetList;
$currentTargets = [];
...
$ensureParentDir = static function (string $targetPath): bool {
    $parentDir = dirname($targetPath);
    if ($parentDir === '' || $parentDir === '.' || is_dir($parentDir)) {
        return true;
    }

    return @mkdir($parentDir, 0775, true) || is_dir($parentDir);
};

$applyPathFromStaging = static function (string $sourcePath, string $targetPath) use (&$applyPathFromStaging, $ensureParentDir): bool {
