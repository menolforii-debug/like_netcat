...
- `settings_json` стоит трактовать как набор параметров рендера (выбор варианта вывода,
  лимиты, тексты, CSS‑классы). Для логики, SQL и вычислений он не предназначен.
