...
В админском layout подключаются:

```
<script src="https://cdn.jsdelivr.net/npm/tinymce@8.3.2/tinymce.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tinymce@8.3.2/skins/ui/oxide/content.min.css">
```
